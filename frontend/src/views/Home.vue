<template>
    <main class="parallax-container" @wheel.prevent="wheelScrollingOffset">
        ...
        <div class="parallax-layer-2 parallax-layer"
        ...
        <div class="parallax-layer-1 parallax-layer"
        ...
        <div class="parallax-layer-2-tag parallax-layer"
             :style="{width: scaleFullWidth, transform: 'translateX(' + offsetParallax + 'px)'}">
            <tag
                    :version=1
                    :scaleId=2
        ...
        <div class="parallax-layer-1-tag parallax-layer"
             :style="{width: scaleFullWidth, transform: 'translateX(' + offsetParallax + 'px)'}"></div>
