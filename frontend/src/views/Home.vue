<template>
  <main class="parallax-container" @wheel.prevent="wheelScrollingOffset">
    <div
      class="parallax-layer-2 parallax-layer"
      :style="{width: scaleFullWidth, transform: 'translateX(' + offsetParallax*0.6 + 'px)'}"
    >
      <scale :startDate="2010" :endDate="2028" :step="1" :ratio="0.95" />
    </div>
    <div
      class="parallax-layer-1 parallax-layer"
      :style="{width: scaleFullWidth, transform: 'translateX(' + offsetParallax + 'px)'}"
    >
      <scale :startDate="2010" :endDate="2028" :step="1" :ratio="1.0" ref="scaleL" />
    </div>
